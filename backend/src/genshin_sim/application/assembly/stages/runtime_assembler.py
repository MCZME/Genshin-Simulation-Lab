...
from genshin_sim.application.assembly.buffs import (
    ...
    build_max_hp_affected_buff_keys,
...
class RuntimeAssembler:
    ...
    def assemble(
        ...
        buff_max_hp_coordinator = BuffMaxHpChangeCoordinator(
            ...
            projection_port=ProjectedBuffMaxHpResolver(attribute_runtime.resolver, buff_store),
            event_engine=context.events,
            max_hp_definition_keys=build_max_hp_affected_buff_keys(
                definitions=buff_registry.definitions,
                attribute_definitions=attribute_runtime.definitions,
                modifier_providers=attribute_runtime.modifier_index.providers,
            ),
        )
        ...
        runtime_world.add(FramePhase.TIME_ADVANCE, "buff", buff_max_hp_coordinator)
        ...
        return AssembledSimulation(
            ...
            buff_runtime=buff_runtime,
            buff_max_hp_coordinator=buff_max_hp_coordinator,
            buff_handler=buff_handler,
